...
if __name__=='__main__':
    ...
    minimax_black = MiniMaxBlackGame(depth)
    root = Node(minimax_black.gmo.reversePosition(currBoardPos), 0)
    minimaxEstimation = minimax_black.maxMin(root)
    bestPos = minimax_black.gmo.reversePosition(minimax_black.maxPos)
    ...
    print(f"Depth : {depth}")
    print("--------------- MiniMaxBlackGame  ----------------")
    print(f"Board Position: {bestPos}")
    print(f"Positions evaluated by static estimation: {minimax_black.countStaticEstimation}")
