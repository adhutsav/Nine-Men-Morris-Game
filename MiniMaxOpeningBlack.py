...
if __name__=='__main__':
    ...
    minimax_black_opening = MiniMaxBlackOpening(depth)
    root = Node(minimax_black_opening.gmo.reversePosition(currBoardPos), 0)
    minimaxEstimation = minimax_black_opening.maxMin(root)
    bestPos =  minimax_black_opening.gmo.reversePosition(minimax_black_opening.maxPos)
    ...
    print(f"Positions evaluated by static estimation: {minimax_black_opening.countStaticEstimation}")
